...
execute store result score @s dvh.max_health run data get storage doom.vh:ctx _.max_health 1000
execute if score @s dvh.max_health matches ..0 run scoreboard players set @s dvh.max_health 1000
execute store result score @s dvh.health run data get storage doom.vh:ctx _.health 1000
